...
public class ReligiousFragment extends Fragment {
    ...
    private static final String CATEGORY_RELIGIOUS = "Religious";
    RecyclerView rv;
    LinearLayoutManager linearLayoutManager;
    DatabaseReference db;
//    FirebaseAuth mAuth;
    FirebaseRecyclerAdapter<Article, ArticleViewHolder> firebasenewsRecycleAdapter;
    ProgressBar progressBarReligionList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_religious, container, false);
        //Initialize Firebase DB
        db = FirebaseDatabase.getInstance().getReference();


        //SETUP RECYCLER
        rv = (RecyclerView) rootView.findViewById(R.id.recyclerViewReligionList);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        linearLayoutManager.setStackFromEnd(false);


        progressBarReligionList = (ProgressBar) rootView.findViewById(R.id.progressBarReligionList);
        progressBarReligionList.setVisibility(View.VISIBLE);

        Query query = db.child("Articles").orderByChild("category").equalTo(CATEGORY_RELIGIOUS);
...
//                viewHolder.textViewListArticleCategory.setText(model.getCategory());
                ...
                progressBarReligionList.setVisibility(View.GONE);
